...
class GenderViewModel @Inject constructor(
    ...
    val uiState: StateFlow<GenderUiState>
        get() = _uiState
    ...
    override fun onNameChange(name: String) {
        ...
        viewModelScope.launch {
            when (val result: DataResult<GenderUi> = getGenderByName(name)) {
                ...
                is DataResult.Failure.Remote.Else, DataResult.Failure.Local -> GenderUiState.Failure.Else
